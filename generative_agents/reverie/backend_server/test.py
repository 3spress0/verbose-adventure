...
written for the OpenAI APIs; this version has been patched to use the
...
Same surface as ``persona/prompt_template/gpt_structure.py``; this
file just exposes a quick ``python test.py`` smoke test.
"""
import json
import random
import time
